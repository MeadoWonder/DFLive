...
class YoloV5Face:
    ...
    def __init__(self, device_info: ORTDeviceInfo, path=Path(__file__).parent/'models/YoloV5Face.onnx'):
    ...
    def extract(self, img, threshold : float = 0.3, fixed_window=0, min_face_size=8, augment=False, is_bgr=True):
        """
        arguments
